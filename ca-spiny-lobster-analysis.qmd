...
lobster_temp_august_full <- inner_join(lobster_august, site_temps)

lobster_temps <- lobster_temp_august_full %>% 
...
august_temp_trends <- ggplot(data = lobster_temps, aes(x = year, y = avg_temp)) +
...
- $\beta_{0}$ is the intercept, or expected average carapace length, in millimeters
